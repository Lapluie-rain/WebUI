...
class Customer(object):
    ...
    def __init__(self):
        self.a = ExcelData("快速创建目标客户")
        self.b = Login()
        self.b.login()
        self.driver = self.b.driver

    def quick_c(self):  # 快速创建
        return self.driver.find_element_by_class_name(self.a.get_data('quick_creation'))

    def customer1(self):  # 目标客户
        return self.driver.find_element_by_xpath(self.a.get_data('target_customer1'))
    ...
    def jg(self):   # 选择加工方式，木工机加
        return self.driver.find_element_by_xpath(self.a.get_data('jiagong'))
    ...
    def customer2(self):    # 目标客户
        return self.driver.find_element_by_xpath(self.a.get_data('target_customer2'))
