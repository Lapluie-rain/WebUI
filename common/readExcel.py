...
class ExcelData():
    ...
    def __init__(self, sheetName):
        self.excel_path = "../page/WebElement.xls"  # 指定Excel读取的路径
...
if __name__ == "__main__":
    ...
    print("读取的数据为列中，把列中的字典取出来为：", a.list_to_dict())
    # print("取excel中current_url的具体值为：", a.get_data("current_url"))